...
def CalculateWheelVelocity(targetX, targetY):
    ...
    RobotHomeX = 0.0;
    RobotHomeY = 0.0;
    wheelOffset = 0.12; # distance from wheel to wheel drive center
    wheelRadius = 0.05;
    wheelLHomeX = 0.0;
    wheelRHomeX = 0.0;
    wheelLHomeY = 0.0;
    ...
    angularVelocity = 0.0;
    linearVelocity = 0.15; # we are going to start with having a linear velocity of 0.15 m/s
    percentFaster = 0;
